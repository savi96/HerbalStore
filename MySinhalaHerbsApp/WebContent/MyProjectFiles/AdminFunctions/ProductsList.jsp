...
<body>
 <header>
  <nav class="navbar navbar-expand-md navbar-dark"
   ...
   <ul class="navbar-nav">
    <li>
    	<a href="<%=request.getContextPath()%>/list" class="nav-link">Category</a>
    </li>
   </ul>
 ...
 <div class="row">
  ...
  <div class="container">
   ...
   <div class="container text-left">
    <a href="<%=request.getContextPath()%>/new" class="btn btn-success">Add Category</a>
   </div>
   <br>
    ...
    <tbody>
     ...
     <c:forEach var="category" items="${listCategory}">
      ...
      <tr>
       ...
       <td><c:out value="${category.targetDate}" /></td>
       <td><c:out value="${category.status}" /></td>

       <td>
       		<a href="edit?id=<c:out value='${category.id}' />">Edit</a>
       			&nbsp;&nbsp;&nbsp;&nbsp; 
